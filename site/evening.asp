...
<body class="sticky-header header-center-over page-header-style-1 footer-style-8 preload">
    ...
    <div id="main-container">
        ...
        <!-- PAGE CONTENT -->
        <div id="page-content" class="evening">

            <div id="page-header">

                <div class="ken-burns" style="background-image:url('assets/images/mpg/headers/EveningEvents.jpg');"></div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Evening Events</li>
                            </ol>
                ...
                <div class="row">
                    <div class="col-md-12 noleftrightpadding" ng-app="RFG2020" ng-controller="Controller" ng-cloak>
                        ...
                        <div class="isotope cols-2 mb-0 topactivity">
                            <div class="isotope-item {{x.days}} {{x.type}}" ng-repeat="x in evening">
                                <div class="valueitem" val="{{x.id}}">
                                    <div class="portfolio-item">

                                        <div class="portfolio-item-thumbnail">

                                            <a ng-href="innerevening.asp?id={{x.id}}" id="activity{{x.id}}">
                                                <img ng-src="assets/images/mpg/evening/inner/{{x.id}}.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="portfolio-item-description">
                                            <h5 class="text-center"><a ng-href="innerevening.asp?id={{x.id}}"
                                            ...
                                            <div class="mydiv" ng-cloak style="text-align:center;">
                                                ...
                                                <span class="enh_port_subtitle timeday1"
                                                    ng-show="x.eveningdateone">{{x.eveningdateone}}<br /></span>
                                                <span class="enh_port_subtitle timeday2"
                                                    ng-show="x.eveningdatetwo">{{x.eveningdatetwo}}<br /></span>
                                                <span class="enh_port_subtitle timeday3"
                                                    ng-show="x.eveningdatethree">{{x.eveningdatethree}}<br /></span>
                                                                                           </div>
                                        </div>
                                    </div>
                                </div>
