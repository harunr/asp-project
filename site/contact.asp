...
<body class="sticky-header header-center-over page-header-style-1 footer-style-8 preload">
    ...
    <div id="main-container">
        ...
        <!-- PAGE CONTENT -->
        <div id="page-content" class="contactpage">

            <div id="page-header">

                <div class="ken-burns" style="background-image:url('assets/images/mpg/headers/ContactUs.jpg');"></div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        ...
                        <p>If you have questions or comments or need additional information about the Ricoh Family Group awards trip to Sicily, please contact your District Business Manager or:</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <!-- <div class="team-member-box">
                                    <h4><a href="#">Ricoh STAR Headquarters</a></h4>
                                    <p><a href="mailto:RicohSTAR2019@madisonpg.com">RicohSTAR2019@madisonpg.com</a>
                                        <br />
                                        Phone: 888-231-9187 (ID# 7070)
                                    </p>
                                    <a class="waves" href="mailto:RicohSTAR2019@madisonpg.com">+</a>
                                </div> -->
                                <div class="team-member-box">
                                   <p>Director, Corporate Events</p>
                                    <h4><a href="#">Ms. Sue Ann Timco</a></h4>
                                    <p><a href="mailto:Sueann.timco@ricoh-usa.com">Sueann.timco@ricoh-usa.com</a>
                                      
                                    </p>
                                    <a class="waves" href="mailto:Sueann.timco@ricoh-usa.com">+</a>
                                </div>
