    ...
    <div id="main-container">
        ...
        <div id="page-content" class="skeleton">
            ...
            <div class="col-md-12" style="text-align: center;">
                <a class="btn btn-style-1 waves mb-5 mb-md-0 " href="activities.asp">Go Back To
                    Activities</a>
                    <br />
                    <br /><br />
            </div>
            ...
            <div class="container mt-3" ng-app="RFG2020" ng-controller="Controller" ng-cloak>
                <div class="row">
                    <div class="col-md-12">
<h1 class="text-center">Day 3 Activities</h1>
                        <div class="owl-carousel activity-slider" >
                            <div class="item" ng-repeat="x in activities    | filter: { days: 'day3'}">
                                <div class="restcarousel text-center">
                                    <a ng-href="inneractivitydaythree.asp?id={{x.id}}"><img ng-src="assets/images/mpg/activities/outer/{{x.id}}.jpg"
                                            alt="">
