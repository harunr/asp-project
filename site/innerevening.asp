...
<body class="sticky-header header-center-over page-header-style-1 footer-style-8 preload">
    ...
    <div id="main-container">
        ...
        <!-- PAGE CONTENT -->
        <div id="page-content" class="skeleton">

       


            <div id="activitycontent"></div>
            <div id="activitycontentfailed">
                <h1 class="text-center">Please try again later!</h1>
            </div>
            <div class="container mt-3">
                <div class="row">
                    <div class="col-md-12" style="text-align: center;">
                        <a class="btn btn-style-1 waves mb-5 mb-md-0 " href="evening.asp">Go Back To
                            Evening Events</a>
                        <br />
                        <br /><br />
                    </div>
            ...
            <div class="container mt-3" ng-app="RFG2020" ng-controller="Controller" ng-cloak>
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-center">All Evening Events</h1>
                        <div class="owl-carousel activity-slider">
                            <div class="item" ng-repeat="x in evening">
                                <div class="restcarousel text-center">
                                    <a ng-href="inneractivity.asp?id={{x.id}}"><img
                                            src="assets/images/mpg/evening/outer/{{x.id}}.jpg" alt="">
                                        <h4 class="text-center" ng-bind-html="x.title"></h4>
                                    </a>
                                </div>
                            </div>
    ...
    <script src="assets/js/evening.js"></script>
